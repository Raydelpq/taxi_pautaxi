    ...
    <div> 
        ...
        <div class="grid grid-cols-12 gap-4 items-center">
            ...
            <div class="col-span-full sm:col-span-6">
                <i class="fas fa-exclamation-triangle h-full w-full text-danger-600 text-center text-[200px] sm:text-[300px]"></i>
            </div>

            <div class="grid col-span-full sm:col-span-6 justify-center">
                <h3 class="text-danger-600 animate-bounce text-center text-5xl">OopSSSSSS!</h3>
                <h3 class="px-3">Ha Ocurrido un error inesperado en el servidor, regrese a la página anterior o al panel de control. Si el error insiste comuníquese con el administrador del sistema </h3>
